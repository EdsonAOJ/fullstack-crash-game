...
import { RABBITMQ_EXCHANGE, WALLET_COMMANDS_QUEUE } from "./rabbitmq.constants";
  ...
  implements OnModuleInit, OnModuleDestroy
{
  ...
  private async initializeConnection(): Promise<void> {
    ...
    await this.channel.assertQueue(WALLET_COMMANDS_QUEUE, {
      durable: true,
    });
    ...
    console.log("Wallet RabbitMQ connection initialized.");
  }
